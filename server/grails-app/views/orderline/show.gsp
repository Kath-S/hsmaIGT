...
<html>
    ...
    <body>
        ...
        <div id="show-orderline" class="content scaffold-show" role="main">
            ...
            <f:display bean="orderline" />
            <g:form resource="${this.orderline}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.orderline}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
